 ...
 */
final class Version20211225112430 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE screenshot ADD COLUMN created_on DATETIME NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__screenshot AS SELECT id, url, width, height, output, file_type, lazy_load, dark_mode, grayscale, delay, user_agent, full_page, fail_on_error, clip_x, clip_y, clip_w, clip_h FROM screenshot');
        ...
        $this->addSql('INSERT INTO screenshot (id, url, width, height, output, file_type, lazy_load, dark_mode, grayscale, delay, user_agent, full_page, fail_on_error, clip_x, clip_y, clip_w, clip_h) SELECT id, url, width, height, output, file_type, lazy_load, dark_mode, grayscale, delay, user_agent, full_page, fail_on_error, clip_x, clip_y, clip_w, clip_h FROM __temp__screenshot');
